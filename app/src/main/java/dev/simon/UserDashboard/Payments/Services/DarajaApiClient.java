...
import static dev.simon.UserDashboard.Payments.Constants.BASE_URL;
import static dev.simon.UserDashboard.Payments.Constants.CONNECT_TIMEOUT;
import static dev.simon.UserDashboard.Payments.Constants.READ_TIMEOUT;
import static dev.simon.UserDashboard.Payments.Constants.WRITE_TIMEOUT;

import java.util.concurrent.TimeUnit;

import dev.simon.UserDashboard.Payments.Interceptor.AccessTokenInterceptor;
import dev.simon.UserDashboard.Payments.Interceptor.AuthInterceptor;
